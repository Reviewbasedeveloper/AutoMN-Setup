#!/bin/bash
# ReviewBaseCoin Masternode Setup Script V1 for Ubuntu 18.04 LTS
#
...
echo -e "${GREEN} ------- reviewbase_coin MASTERNODE INSTALLER v1.0.0--------+
 |                                                  |
 |                                                  |::
...
wget https://github.com/Reviewbasedeveloper/RVIEW-Coin/releases/download/v1.0/RVIEW-1.0-daemon-ubuntu_18.04.tar.gz
tar -xzvf RVIEW-1.0-daemon-ubuntu_18.04.tar.gz
...
cd ~/.reviewbase_coin/ && wget https://github.com/reviewbase_coinCTO/reviewbase_coin-core/releases/download/v1.0/bootstrap.zip
